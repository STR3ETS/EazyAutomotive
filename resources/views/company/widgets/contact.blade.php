    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="ctl-info mb-5 flex items-start gap-3 bg-[#215558]/[0.04] border border-[#215558]/10 text-[#215558] px-5 py-3.5 rounded-xl">
                ...
                <p class="text-sm opacity-80">Kleur en lettertype neemt deze widget automatisch over van je <a href="{{ route('widgets.voorraad') }}" class="text-eazy font-semibold hover:underline">voorraad-widget-thema</a>, zodat alles bij elkaar past.</p>
            </div>
